...
示例代码片段：[wechatide://minicode/6bRiVtme7i3q](wechatide://minicode/6bRiVtme7i3q)
...
> 以下示例假定 miniprogrampatch.js 文件放置于项目根目录，示例代码参见[miniprogramapp](wechatide://minicode/6bRiVtme7i3q)。
